             ...
             <View style={{flex:1,backgroundColor:'#f5f5f5'}}>
                <View style={{height:44,backgroundColor:'black',flexDirection:'row'}}>
                    ...
                    <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                       <Text style={{fontSize:17,color:'white',alignSelf:'center',marginTop:7}}>购物车</Text>   
                    </View>  
                    <View>
                        <TouchableOpacity onPress={()=>{this.topItemAction(0)}} 
                                          style={{width:44,height:44,justifyContent:'center',alignItems:'center'}}>
                            <Image source={require('../imgs/cart/ic_cart_btn_delete.png')} style={{width:17,height:21,marginTop:7}}/>
                        </TouchableOpacity>
                    </View>
                </View>
